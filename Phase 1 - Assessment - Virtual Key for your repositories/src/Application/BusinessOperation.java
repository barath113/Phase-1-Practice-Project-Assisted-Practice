...
public class BusinessOperation {	
	...
	protected static void listFiles() {	
		...
		File directoryPath = new File("E:\\fileproblem\\");			
	...
	protected static void deleteFile(String fileToBeDeleted) {						
		File file = new File( "E:\\fileproblem"+ "\\" + fileToBeDeleted );						
		if(file.exists()) {				
			if ( file.delete() ) {					
	...
	protected static void searchFile(String fileToBeSearched) {		
		File file = new File( "E:\\fileproblem" + "\\" + fileToBeSearched );						
		...
		PrintWriter pw;
			try {pw = new PrintWriter(fileToBeSearched); //may throw exception   	            
			pw.println("saved");
	...
	protected static void createFile (String fileToBeCreated) {			
		File file = new File( "E:\\fileproblem" + "\\" + fileToBeCreated );						
		try {				
